...
def get_recommendations_user(top_m, discription, brons, n_ids):
    ...
    # knn
    row_dense = svd.transform(sparse_matrix_for_user)
    ...
    recommended_items = top_indices[:15]

    # Создание датафрейма
    df = pd.DataFrame({'id': recommended_items})
